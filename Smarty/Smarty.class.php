...
class Smarty
{
     ...
     * $smarty->display('file:index.tpl.tpl');
     * $smarty->display('db:index.tpl.tpl');
     * $smarty->display('index.tpl.tpl'); // will use default resource type
     * {include file="file:index.tpl.tpl"}
     * {include file="db:index.tpl.tpl"}
     * {include file="index.tpl.tpl"} {* will use default resource type *}
     *
     * @var array
     */
