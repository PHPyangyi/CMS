...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_section_start($tag_args)
    {
        ...
        $output .= "if ({$section_props}['show']):\n";
        $output .= "
            for ({$section_props}['index.tpl'] = {$section_props}['start'], {$section_props}['iteration'] = 1;
                 {$section_props}['iteration'] <= {$section_props}['total'];
                 {$section_props}['index.tpl'] += {$section_props}['step'], {$section_props}['iteration']++):\n";
        $output .= "{$section_props}['rownum'] = {$section_props}['iteration'];\n";
        $output .= "{$section_props}['index_prev'] = {$section_props}['index.tpl'] - {$section_props}['step'];\n";
        $output .= "{$section_props}['index_next'] = {$section_props}['index.tpl'] + {$section_props}['step'];\n";
            ...
            foreach ($_indexes as $_index) {
                if (substr($_index, 0, 1) == '[') {
                    ...
                    if (is_numeric($_index)) {
                        ...
                        $_var_section_prop = isset($_var_parts[1]) ? $_var_parts[1] : 'index.tpl';
